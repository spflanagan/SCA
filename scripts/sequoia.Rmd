...
```{r}
gt<-read.delim("relatedness/coancestry_gty.txt",sep=sep,header=FALSE)
ped<-data.frame(FamID=LifeHistData$ID,IndID=LifeHistData$ID,PatID=0,
...
ped[ped[,3]=="086-23",1]<-"08623"
ped[ped[,3]=="086R",1]<-"086"
...
`plink --file C:\Users\sflan\Documents\GitHub\SCA\results\sequoia\GenoM --maf 0.4 --indep 50 5 2 --allow-extra-chr --make-founders --recode --out C:\Users\sflan\Documents\GitHub\SCA\results\sequoia\PrunedGenoM`
...
seq_ped<-sequoia(GenoM_ped,LifeHistData,MaxSibIter=0,MaxSibshipSize = 200,Tassign = 0)
```
